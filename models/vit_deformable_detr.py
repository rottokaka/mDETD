...
from .vit_deformable_transformer import build_deforamble_transformer, build_vit_deforamble_transformer, build_vit_deforamble_transformer_full
import copy
...
class ViTDeformableDETRFull(nn.Module):
...
class ViTDeformableDETR(nn.Module):
    """ This is the Deformable DETR module that performs object detection """
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels,
                 aux_loss=True):
        """ Initializes the model.
...
def build(args):
    ...
    elif args.version == "1" or args.version == "2":
