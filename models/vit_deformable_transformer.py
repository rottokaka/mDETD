...
class ViTDeformableTransformer(nn.Module):
...
class ViTDeformableTransformerFull(nn.Module):
    def __init__(self, d_model=256, nhead=8, 
...
def build_vit_deforamble_transformer(args):
    return ViTDeformableTransformer(
...
def build_vit_deforamble_transformer_full(args):
    return ViTDeformableTransformerFull(
        d_model=args.hidden_dim,
        nhead=args.nheads,
